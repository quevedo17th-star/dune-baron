...
const Game = (function () {
    ...
    const cardsData = [
        {
            ...
            ifFalse: "<ul><li><b>Acción:</b> Colocar 2 Fichas de Gusano.</li><li><b>Ubicación:</b> En Desierto Profundo cerca del Sietch Defensivo.</li></ul>",
        ...
        },
        {
            ...
            ifTrue: "<ul><li><b>Acción:</b> Hacedor Salvaje Ataca o se Mueve.</li><li><b>Prioridad:</b> Hacia la Legión de mayor poder de combate.</li></ul>",
        ...
        },
        {
            ...
            ifTrue: "<ul><li><b>Acción:</b> Mover una Legión Harkonnen desde una Montaña hacia un Desierto.</li><li><b>Prioridad:</b> Polo Norte.</li></ul>",
            ifFalse: "<ul><li><b>Acción:</b> Colocar a Paul + 1 Ficha de Despliegue.</li><li><b>Ubicación:</b> En un Sietch Ofensivo.</li></ul>",
            add: "<ul><li><b>Recuperar Líder:</b> Si hay un Líder Nombrado en el Tanque, colócalo en el Sietch Defensivo con 1 unidad regular (solo líder si llena el límite).</li><li><b>Prioridad:</b> Paul > Gurney > Stilgar > Otros.</li></ul>"
        },
        {
            file: "4.png",
            cond: "Gusano de Arena en juego",
            ifTrue: "<ul><li><b>Acción:</b> Gusano Ataca o se Mueve.</li><li><b>Objetivo:</b> Si ataca, elige la Legión enemiga de mayor valor (evitando Desierto Profundo).</li></ul>",
        ...
        },
        {
            ...
            ifTrue: "<ul><li><b>Acción:</b> Colocar a la Reverenda Madre Jessica + 1 Unidad de Élite.</li><li><b>Ubicación:</b> En un Sietch Defensivo.</li></ul>",
            ifFalse: "<ul><li><b>Acción:</b> Colocar a Stilgar + 2 Unidades de Élite + 1 Unidad Regular.</li><li><b>Ubicación:</b> Adyacente a una Legión Harkonnen.</li></ul>",
            add: "Revelar Estación Ecológica."
        },
        {
            file: "7.png",
            cond: "Presciencia Verde ≥ 3",
            ifTrue: "<ul><li><b>Acción:</b> Colocar al Líder Muad'Dib + 2 Unidades de Élite en un Sietch Ofensivo.</li></ul>",
        ...
        },
        {
            ...
            ifFalse: "<ul><li><b>Acción:</b> Colocar Hacedor Salvaje en desierto cercano a una Legión en Imperial Basin.</li><li><b>Desempate:</b> Legión más cercana a Imperial Basin en el área de Polo Norte.</li></ul>",
            add: "<ul><li>Revelar Estación Ecológica.</li><li>Atreides recibe +1 Dado.</li></ul>"
        },
        {
            file: "9.png",
            ...
            ifFalse: "<ul><li><b>Acción:</b> Colocar a Gurney + 2 Unidades de Élite en un Desierto.</li><li><b>Prioridad:</b> Cerca de un Sietch Ofensivo.</li></ul>",
            add: "<ul><li><b>Recuperar Líder:</b> Si hay un Líder Nombrado en el Tanque, colócalo en el Sietch Defensivo con 1 unidad regular (solo líder si llena el límite).</li><li><b>Prioridad:</b> Paul > Gurney > Stilgar > Otros.</li></ul>"
        },
        {
            file: "10.png",
            ...
            add: "<ul><li>Jugar 1ª acción de la Carta de Objetivo.</li><li>Atreides recibe +1 Dado en el próximo combate.</li></ul>"
        },
        {
            file: "11.png",
            cond: "TODOS los marcadores de Presciencia ≥ 3 (Bandera)",
            ifTrue: "<ul><li><b>Acción:</b> Una Legión con Líder Ataca (Bonus: +1 Dado en cada asalto).</li><li><b>Alternativa:</b> Si no puede atacar, mueve hacia una Legión enemiga.</li></ul>",
            ifFalse: "<ul><li><b>Acción:</b> Colocar 2 Fichas de Gusano.</li><li><b>Ubicación:</b> En Desierto cercano al Sietch Ofensivo (hacia Imperial Basin).</li></ul>",
        ...
        },
        {
            file: "12.png",
            cond: "TODOS los marcadores de Presciencia ≥ 3 (Bandera)",
            ifTrue: "<ul><li><b>Ataque Especial (3 Dados):</b> Ataca a la Legión enemiga de mayor poder. 1 Impacto por cada Espada o Especial.</li></ul>",
            ifFalse: "<ul><li><b>Acción:</b> Colocar 2 Fichas de Gusano.</li><li><b>Ubicación:</b> En Desierto cercano a la Legión enemiga de mayor poder.</li></ul>",
        ...
        },
        {
            ...
            ifFalse: "<ul><li><b>Despliegue:</b> Colocar un Líder con 2 Fichas de Despliegue en un Sietch Ofensivo.</li></ul>",
            add: "<ul><li>Jugar Carta de Objetivo.</li><li>Atreides recibe +1 Dado.</li></ul>"
        },
        {
            file: "14.png",
            cond: "TODOS los marcadores de Presciencia ≥ 3 (Bandera)",
            ifTrue: "<ul><li><b>Despliegue Alia:</b> Colocar a Alia + 2 Regulares en Sietch Defensivo.</li><li><b>Ubicación:</b> En un Sietch Defensivo.</li></ul>",
            ifFalse: "<ul><li><b>Señal de Gusano:</b> Colocar 2 Fichas de Señal de Gusano.</li><li><b>Ubicación:</b> Desierto cercano a un Sietch Ofensivo en camino a Imperial Basin.</li></ul>",
        ...
        },
        {
            file: "15.png",
            cond: "TODOS los marcadores de Presciencia ≥ 3 (Bandera)",
            ifTrue: "<ul><li><b>Ataque de Gusanos:</b> Colocar 2 Fichas de Gusano en un Desierto adyacente a la Legión enemiga de mayor poder.</li></ul>",
            add: "<ul><li>Revelar Estación Ecológica Y el Automa gana una ficha Bene Gesserit.</li><li>Atreides obtiene +2 Dados.</li></ul>"
        },
        {
            file: "16.png",
            cond: "Presciencia Amarillo ≥ 3 O Rojo ≥ 3 (Bandera)",
            ifTrue: "<ul><li><b>Eliminar Líder:</b> Elige la Legión Harkonnen de mayor poder en un Asentamiento con Líder y retíralo.</li><li><b>Prioridad:</b> Thufir Hawat > Otros > Feyd-Rautha > Gaius Helen Mohiam.</li></ul>",
        ...
        },
        {
            file: "17.png",
            cond: "TODOS los marcadores de Presciencia ≥ 3 (Bandera)",
            ifTrue: "<ul><li><b>Atómicas de Familia:</b> Usar la ficha de Atómicas en la zona más cercana al Sietch Ofensivo.</li></ul>",
        ...
        },
        {
            file: "18.png",
            cond: "TODOS los marcadores de Presciencia ≥ 3 (Bandera)",
            ifTrue: "<ul><li><b>Retirar Cosechadoras (Max 2):</b> Eliminar Cosechadora en Desierto Profundo (o Desierto) a 2 áreas o menos de una Legión Atreides.</li><li><b>Prioridad:</b> Las más cercanas al Sietch Defensivo.</li></ul>",
        ...
        },
        {
            file: "20.png",
            cond: "Presciencia Verde ≥ 6 O Amarillo ≥ 6 O Rojo ≥ 6 (Bandera)",
            ifTrue: "<ul><li><b>Ataque Sorpresa:</b> Una Legión con Líder realiza un Ataque Sorpresa (o se mueve hacia una Legión enemiga).</li></ul>",
    ...
    const objectivesData = [
        ...
        },
        {
            ...
            file: "obj_2.png",
            logic: "<ul><li><b>Acción:</b> Si el Sietch Defensivo NO está revelado, colocar a Paul + 1 Regular allí.</li><li><b>Alternativa:</b> Si otro Sietch NO está revelado, colocar a Paul + 1 Regular allí.</li><li><b>Desempate:</b> El Sietch más cercano al Sietch Defensivo.</li><li><b>Fin de Ronda:</b> Revelar el Sietch donde esté Paul.</li></ul>"
        },
        {
            id: 3,
            title: "Disciplina del Agua",
            desc: "<b>Victoria:</b> Paul y Jessica están JUNTOS en una región de Desierto Profundo (sin Sietch).",
            file: "obj_3.png",
        ...
        },
        {
            ...
            file: "obj_6.png",
            logic: "<ul><li><b>Movimiento IA:</b> Mover a Paul hacia la ubicación de Jessica y a Jessica hacia Paul.</li><li><b>Objetivo:</b> Que ambos terminen su movimiento en el mismo Sietch (base segura).</li><li><b>Última Acción:</b> Colocar Ficha de Despliegue en Sietch Defensivo.</li></ul>"
        },
        {
            id: 7,
            ...
            file: "obj_7.png",
            logic: "<ul><li><b>Movimiento IA:</b> Expansión agresiva. <b>MUEVE 2 VECES</b> legiones a cualquier zona de desierto vacía.</li><li><b>Estrategia:</b> Prioriza la cantidad de zonas ocupadas sobre la calidad de la defensa.</li></ul>"
        },
        {
            id: 8,
            ...
            file: "obj_8.png",
            logic: "<ul><li><b>Acción 1:</b> Colocar a Paul + 1 Unidad Regular en el Sietch Defensivo.</li><li><b>Acción 2:</b> Colocar Ficha de Despliegue en el Sietch Defensivo.</li><li><b>Fin de Ronda:</b> Revelar 2 Fichas de Despliegue.</li></ul>"
        }
    ];
...
const UI = (function () {
    ...
    let currentTacticsData = [];

    function expandCard(type, index = 0) {
        const modal = document.getElementById('imageModal');
        const img = document.getElementById('imageModalImg');
        const title = document.getElementById('imageModalTitle');

        if (type === 'objective' && activeObjective) {
            title.innerText = activeObjective.title;
            img.src = activeObjective.file;
            showObjectiveDetails(activeObjective); // Keep using specific details modal for objective logic explanation
            return;
        } else if (type === 'tactic') {
            const card = currentTacticsData[index];
            if (card) {
                title.innerText = card.name;
                img.src = card.file;
                UI.toggleModal('imageModal');
            }
        }
    }
    ...
    function renderTactics(tactics) {
        currentTacticsData = tactics; // Store for zoom
